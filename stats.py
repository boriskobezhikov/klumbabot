...
# Прикидка на один вызов — по типичному размеру промпта и ответа.
COST_PER_CALL = {
    "claude_extract": 600 / 1_000_000 * 1.0 + 200 / 1_000_000 * 5.0,
    "claude_match": 700 / 1_000_000 * 1.0 + 100 / 1_000_000 * 5.0,
}
